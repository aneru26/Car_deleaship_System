...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{ url('supplier/parts/add')}}" class="btn btn-primary">Add New Parts</a>
          </div>
          ...
          @include(' _message')
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Parts List</h3>
              </div>
              <!-- /.card-header -->
  ...
  <div class="btn-group">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="{{ url('supplier/parts/edit/'.$value->id) }}">Edit</a>
      <a class="dropdown-item" href="{{ url('supplier/parts/delete/'.$value->id) }}">Delete</a>
    </div>
  </div>
</td>
